                ...
                <table class="table">
                    ...
                    ?>
                        ...
                        <form action="<?php echo _WEB_ROOT ?>/qlyhopdong/suacontract" method="post">
                            <div id="Edit-contract-<?php echo $id ?>" class="modal" tabindex="-1" role="dialog" style="display: none; margin-top: 5%; overflow: auto;">
                                <div class="modal-dialog modal-dialog-scrollable" role="document">
                                    <div class="modal-content ">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Sửa thông tin hợp đồng <?php echo $id ?></h5>
                                            <input type="hidden" value="<?php echo $id ?>" name="id">
                                            <button type="button" onclick="hidenEditContract('<?php echo $id ?>')" class="close" data-dismiss="modal" aria-label="Close" style="outline: none; background: red; border-bottom-left-radius: 5px;">
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-5 table" style="display: flex; gap: 1rem;">
                                                ...
                                                <div>
                                                    ...
                                                    <label for="name"><?php echo $studentname ?></label>
