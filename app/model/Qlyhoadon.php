...
class Qlyhoadon extends Controller
{
    ...
    public function searchlastbill()
    {
        if (isset($_POST["id"])) {
         ...
         ";
             $list2 = $this->model_home->query($sql);
             $output = "";
             $i=1;
             foreach ($list2 as $list1) {
                ...
                <tr>
                    ...
                    <td> <a id='deleteLink' href='http://localhost/WEBQUANLYKTX/qlyhoadon/delete/id=" . $id . "' onclick='deleteRoom('" . $id . "')'>
                ...
                $output .= "
                        <div class='mb-3' style='display: flex; gap: 2rem; padding: 10px;'>
                            <div>
                                ...
                                <input type='text' name='id' id='id' class='form-control' style=' font-size: 1.6rem; background: #F5F5F5;'>
                            </div>
                            <div>
                        ...
                        <div class='mb-3' style='display: flex; gap: 2rem; padding: 10px;'>
                            <div>
                                ...
                                <input type='text' class='studentid form-control' name='contractid' id='contractid'  value=" . $contractid . " style='max-width: 600px; font-size: 1.6rem; background: #F5F5F5;'>
                            </div>
                            <div>
                                <label style='font-size: 1.4rem;'>Mã service</label>
                                <input type='text' class='studentid form-control' name='serviceid' id='serviceid' value=" . $serviceid . " style='max-width: 600px; font-size: 1.6rem; background: #F5F5F5;'>
                            </div>
                            <div>
                        ...
                        <div class='mb-3' style='display: flex; gap: 2rem; padding: 10px;'>
                            ...
                            <div>
                                ...
                                <input type='text' class='studentid form-control' name='cost' id='cost' value=" . number_format($total_cost, 0) . " style='max-width: 600px; font-size: 1.6rem; background: #F5F5F5;'>
                            </div>
                            <div>
                        ...
                        <div class='mb-3' style='display: flex; gap: 3rem; padding: 10px;'>
                            <div class='form-check'>
                                <input class='form-check-input' type='checkbox' name='status' id='status' value='1' style='transform: scale(2); padding: 10px;'>
                            ...
                            <div>
                                ...
                                <textarea name='description' id='description' class='form-control'   cols='60' rows='3' style='background: #F5F5F5;'></textarea>
                            </div>
                        </div>
    ...
    public function searchDate()
    {
        if (isset($_POST["id"])) {
            ...
            FROM student
            LEFT JOIN servicebill ON servicebill.roomid=student.roomid
            WHERE student.id like '$key'";
