...
class Qlyhopdong extends Controller
{
    ...
    public function showformsua()
    {
        ...
        $sql_contract = "SELECT contract.* FROM contract WHERE contract.id like '%$%'";
        $this->data['info'] = $this->model_home->query($sql_contract);
        $this->data['content'] = 'staff/NV_Fixcontract';
        $this->render('layout/staff_layout', $this->data);
    }
